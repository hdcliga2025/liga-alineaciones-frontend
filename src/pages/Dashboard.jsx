      ...
      <section class="dash-grid dash-grid--main">
        ...
        <div class={`main-block ${open === "partidos" ? "open--partidos" : ""}`}>
          ...
          <div id="sub-partidos" class={`subgrid ${open === "partidos" ? "open" : ""}`}>
            <a href="/proximo-partido" class="subcard" onClick={(e)=>{ e.preventDefault(); route("/proximo-partido"); }}>
            ...
            <a href="/vindeiros-partidos" class="subcard" onClick={(e)=>{ e.preventDefault(); route("/vindeiros-partidos"); }}>
              <div class="sub-ico" style="border:1px solid rgba(34,197,94,.55);">
            ...
            <a href="/partidos-finalizados" class="subcard" onClick={(e)=>{ e.preventDefault(); route("/partidos-finalizados"); }}>
              <div class="sub-ico" style="border:1px solid rgba(34,197,94,.55);">
        ...
        <div class={`main-block ${open === "alineacions" ? "open--alineacions" : ""}`}>
          ...
          <div id="sub-alineacions" class={`subgrid ${open === "alineacions" ? "open" : ""}`}>
            {/* ✅ Ahora a la página propia */}
            <a href="/convocatoria-oficial" class="subcard" onClick={(e)=>{ e.preventDefault(); route("/convocatoria-oficial"); }}>
            ...
            <a href="/haz-tu-11" class="subcard" onClick={(e)=>{ e.preventDefault(); route("/haz-tu-11"); }}>
              <div class="sub-ico" style="border:1px solid rgba(245,158,11,.55);">
            ...
            {/* mantenemos temporalmente vistas antiguas por compatibilidad */}
            <a href="/haz-tu-11?view=oficial" class="subcard" onClick={(e)=>{ e.preventDefault(); route("/haz-tu-11?view=oficial"); }}>
              <div class="sub-ico" style="border:1px solid rgba(245,158,11,.55);">
            ...
            <a href="/haz-tu-11?view=normas" class="subcard" onClick={(e)=>{ e.preventDefault(); route("/haz-tu-11?view=normas"); }}>
              <div class="sub-ico" style="border:1px solid rgba(245,158,11,.55);">
        ...
        <div class={`main-block ${open === "clasificacions" ? "open--clasificacions" : ""}`}>
          ...
          <div id="sub-clasificacions" class={`subgrid ${open === "clasificacions" ? "open" : ""}`}>
            <a href="/resultados-ultima-alineacion" class="subcard" onClick={(e)=>{ e.preventDefault(); route("/resultados-ultima-alineacion"); }}>
            ...
            <a href="/taboa-acertos-acumulados" class="subcard" onClick={(e)=>{ e.preventDefault(); route("/taboa-acertos-acumulados"); }}>
              <div class="sub-ico" style="border:1px solid rgba(167,139,250,.55);">
