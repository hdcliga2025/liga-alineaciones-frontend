      ...
      <section class="dash-grid dash-grid--main">
          ...
          >
            ...
            <div class="dash-text">
              ...
              <p class="dash-card-desc">
                Todos os partidos do Celta na tempada 2025/2026
              </p>
            </div>
          </a>
          ...
          >
            ...
            <a href="/proximo-partido" class="subcard">
              ...
              <div class="sub-texts">
                ...
                <p class="sub-desc">
                  Seguinte encontro con data e horario confirmados para xogar a
                  HDCLiga
                </p>
              </div>
            </a>
            ...
            <a href="/vindeiros-partidos" class="subcard">
              ...
              <div class="sub-texts">
                ...
                <p class="sub-desc">
                  Partidos de calquera competición establecidos no calendario
                </p>
              </div>
            </a>
            ...
            <a href="/partidos-finalizados" class="subcard">
              ...
              <div class="sub-texts">
                ...
                <p class="sub-desc">
                  Táboa dos partidos xa rematados co seu resultado
                </p>
              </div>
            </a>
          </div>
        ...
        >
          ...
          >
            ...
            <span
              class={`chev ${open === "alineacions" ? "open" : ""}`}
              style="color:#f59e0b"
            >
              ▾
            </span>
          ...
          <div
            id="sub-alineacions"
            class={`subgrid ${open === "alineacions" ? "open" : ""}`}
          >
            <a href="/convocatoria-oficial" class="subcard">
              ...
              <div class="sub-texts">
                ...
                <p class="sub-desc">
                  Lista comunicada polo club para o seguinte partido
                </p>
              </div>
            </a>
            ...
            <a href="/alineacion-oficial" class="subcard">
              <div
                class="sub-ico"
                style="border:1px solid rgba(245,158,11,.55);"
              >
              ...
              <div class="sub-texts">
                ...
                <p class="sub-desc">
                  O once inicial que cruza automaticamente coas túas aliñacións
                </p>
              </div>
            </a>
        ...
        >
          ...
          >
            ...
            <span
              class={`chev ${open === "clasificacions" ? "open" : ""}`}
              style="color:#a78bfa"
            >
              ▾
            </span>
            <div class="dash-text">
              ...
              <p class="dash-card-desc">
                Resultados por partido e xerais de cada quen
              </p>
            </div>
          </a>

          <div
            id="sub-clasificacions"
            class={`subgrid ${open === "clasificacions" ? "open" : ""}`}
          >
            <a href="/resultados-ultima-alineacion" class="subcard">
              ...
              <div class="sub-texts">
                <p class="sub-title" style="color:#a78bfa">
                  Resultados da última aliñación
                </p>
                <p class="sub-desc">
                  Aquí é onde comprobas os teus acertos e os das túas rivais...
                </p>
              </div>
            </a>
            ...
            <a href="/taboa-acertos-acumulados" class="subcard">
              ...
              <div class="sub-texts">
                ...
                <p class="sub-desc">
                  Clasificación xeral tras os partidos rematados
                </p>
              </div>
            </a>
            ...
            <a href="/resultados-historicos" class="subcard">
              ...
              <div class="sub-texts">
                ...
                <p class="sub-desc">
                  Comproba puntuacións de partidos finalizados
                </p>
              </div>
            </a>
          </div>
