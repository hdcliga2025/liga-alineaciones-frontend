      ...
      <header ref={headerRef} style={styles.header}>
        <div style={styles.container}>
          <div style={styles.leftGroup}>
            ...
            <a href="/notificacions" title="Notificacións" style={styles.iconBtn} onClick={go("/notificacions")} aria-label="Notificacións">
          ...
          <div style={styles.rightGroup}>
            <a href="/perfil" title="Perfil" style={styles.iconBtn} onClick={go("/perfil")} aria-label="Perfil">
              <svg width="22" height="22" viewBox="0 0 24 24" {...common}><circle cx="12" cy="8" r="3.2"/><path d="M4.5 19.5a7.5 7.5 0 0115 0"/></svg>
            </a>
            <a href="/logout?to=/" title="Pechar sesión" style={styles.iconBtn} onClick={onLogout} aria-label="Pechar sesión">
